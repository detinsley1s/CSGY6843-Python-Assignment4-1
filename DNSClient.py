...
domain_list  = ['example.com.', 'safebank.com', 'google.com', 'nyu.edu', 'legitsite.com']
...
# Define a function to print the results from querying both the local and public DNS servers for each domain name in the domain_list
...
if __name__ == '__main__':
    ...
    result = compare_dns_servers(question_type)
    print(result)
